...
// in simulator we redefine to format for TechSupport Developer console
...
{\
	NSString * exceptionName = [@"org.techsupport." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.techsupport";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UITechSupportNativeItemNone = -1, 
	UITechSupportNativeItemSpinner = -2,
	UITechSupportNativeItemProgressBar = -3,
	
	UITechSupportNativeItemSlider = -4,
	UITechSupportNativeItemSwitch = -5,
	UITechSupportNativeItemMultiButton = -6,
	UITechSupportNativeItemSegmented = -7,
	
	UITechSupportNativeItemTextView = -8,
	UITechSupportNativeItemTextField = -9,
	UITechSupportNativeItemSearchBar = -10,
	
	UITechSupportNativeItemPicker = -11,
	UITechSupportNativeItemDatePicker = -12,
	
	UITechSupportNativeItemInfoLight = -13,
	UITechSupportNativeItemInfoDark = -14,
	
	UITechSupportNativeItemDisclosure = -15,
	
	UITechSupportNativeItemContactAdd = -16
};
