...
//@interface TechSupportObject : NSObject
//@end

@interface TechSupportObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TechSupportObject class]])
		{
			for (NSString *key in [[(TechSupportObject*)o modules] allKeys])
			{
